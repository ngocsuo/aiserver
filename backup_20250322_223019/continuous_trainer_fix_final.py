"""
Phiên bản đầy đủ của continuous_trainer.py đã sửa lỗi "too many values to unpack (expected 2)"
CHÚ Ý: Sao chép mã này và tìm phương thức _train_for_timeframe trong file continuous_trainer.py,
sau đó thay thế toàn bộ nội dung phương thức đó bằng phiên bản này.
"""
