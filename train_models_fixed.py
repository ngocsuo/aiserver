"""
Hai hàm train_models và train_models_background đã được sửa để hoạt động đúng trên server.
Sao chép hai hàm này và thay thế toàn bộ hàm cũ trong app.py.

Chú ý: Phần code phía dưới chỉ chứa 2 hàm, không phải toàn bộ file app.py.
"""
